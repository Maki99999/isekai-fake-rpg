...
namespace Default
{
    public class SaveManager : MonoBehaviour
    {
        ...
        private static readonly string[] debugGameFiles = new string[] {
            ...
            ,
            //everything is done, waiting for ending
